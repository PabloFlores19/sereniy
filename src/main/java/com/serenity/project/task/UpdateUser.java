...
public class UpdateUser implements Task {
    ...
    public UpdateUser(String name, String lastName, String address, String phone) {
        this.name = name;
    ...
    public static UpdateUser intoDataBase(String name, String lastName, String address, String phone) {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                Click.on(CrudUserPage.BTN_EDIT),
